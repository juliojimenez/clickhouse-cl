          ...
          do (if (equalp "FORMAT" (token-lexeme lexeme))
                  (progn
                    ...
                    (cond ((equal chosen-format "TabSeparated") (setf *format* 'tabseparated))
                          ...
                          ((equal chosen-format "TabSeparatedRawWithNamesAndTypes") (setf *format* 'tabseparatedrawwithnamesandtypes))
                          ...
                          ((equal chosen-format "Values") (setf *format* 'values))
                          ...
                          ((equal chosen-format "JSONCompactStringsEachRowWithNames") (setf *format* 'jsoncompactstringseachrowwithnames))
                          ((equal chosen-format "JSONCompactStringsEachRowWithNamesAndTypes") (setf *format* 'jsoncompactstringseachrowwithnamesandtypes))
                          ...
                          ((equal chosen-format "PrettyNoEscapesMonoBlock") (setf *format* 'prettynoescapesmonoblock))
                          ((equal chosen-format "PrettyCompact") (setf *format* 'prettycompact))
